...
# 3. Download initial model for rasa
    # Define the URL of the file
    url="https://github.com/RasaHQ/rasa-x-demo/raw/master/models/model.tar.gz"
    # Define the destination directory
    destination="./rasa-bot/models/"
...
# 5. Check that the rasa model server is pointed at the right action server URL
...
# 6. Run Docker Compose which will build the images ands start the 4 servers
